...
<template>
  <div class="skills-section">
    ...
    <div v-if="showSkillForm" class="add-form">
      ...
      <button id="addSkill" class="d-flex align-items-center justify-content-center" @click="add_skill">
    ...
    <div v-else-if="skills.length > 0">
      <div v-for="skill in skills" :key="skill.id" class="skill-card">
        ...
        <div class="skill-icon" @mouseover="skill.isEditing = true" @mouseleave="skill.isEditing = false"
          @click="startEditing(skill)">
          <span class="material-icons">{{ skill.isEditing ? 'edit' : (typeof skill.icon === 'string' ? skill.icon :
            'code') }}</span>
        </div>
